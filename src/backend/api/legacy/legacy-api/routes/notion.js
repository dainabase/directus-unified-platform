...
router.get('/page/:id', async (req, res) => {
  try {
    const page = await notionService.getItems(req.params.id);
...
router.post('/page', async (req, res) => {
  try {
    ...
    const page = await notionService.createItem(database_id, properties, children);
...
router.patch('/page/:id', async (req, res) => {
  try {
    ...
    const updatedPage = await notionService.updateItem(req.params.id, properties);
