/**
 * DataGridAdv Component Tests
 * Auto-generated test suite for data-grid-adv component
 * Category: complex
 */
...
describe('DataGridAdv Component', () => {
  describe('Rendering', () => {
    it('renders without crashing', () => {
      renderWithProviders(<DataGridAdv />);
      expect(document.querySelector('[data-testid="data-grid-adv"]')).toBeInTheDocument();
    });

    it('renders with initial data', () => {
      const data = { /* mock data */ };
      renderWithProviders(<DataGridAdv data={data} />);
      // Verify data is rendered
    });

    it('handles loading state', () => {
      renderWithProviders(<DataGridAdv loading />);
      expect(screen.getByRole('status')).toBeInTheDocument();
      expect(screen.getByText(/loading/i)).toBeInTheDocument();
    });

    it('handles error state', () => {
      renderWithProviders(<DataGridAdv error="Failed to load" />);
  ...
  describe('Data Management', () => {
    it('loads data on mount', async () => {
      ...
      renderWithProviders(<DataGridAdv onLoad={fetchData} />);
    ...
    it('handles data updates', async () => {
      const { rerender } = renderWithProviders(<DataGridAdv data={[]} />);
      expect(screen.getByText(/no data/i)).toBeInTheDocument();
      
      const newData = [{ id: 1, name: 'Item 1' }];
      rerender(<DataGridAdv data={newData} />);
    ...
    it('supports pagination', async () => {
      ...
      renderWithProviders(<DataGridAdv data={data} pageSize={10} />);
    ...
    it('supports sorting', async () => {
      ...
      renderWithProviders(<DataGridAdv data={data} sortable />);
    ...
    it('supports filtering', async () => {
      ...
      renderWithProviders(<DataGridAdv data={data} filterable />);
  ...
  describe('User Interactions', () => {
    it('handles item selection', () => {
      ...
      renderWithProviders(<DataGridAdv data={data} onSelect={handleSelect} />);
    ...
    it('supports multi-selection', () => {
      ...
      renderWithProviders(<DataGridAdv data={data} multiSelect onSelect={handleSelect} />);
    ...
    it('supports drag and drop', async () => {
      ...
      renderWithProviders(<DataGridAdv data={data} draggable onReorder={handleReorder} />);
    ...
    it('supports inline editing', async () => {
      ...
      const data = [{ id: 1, name: 'Item 1' }];
      renderWithProviders(<DataGridAdv data={data} editable onEdit={handleEdit} />);
  ...
  describe('Performance', () => {
    it('virtualizes long lists', () => {
      ...
      renderWithProviders(<DataGridAdv data={data} virtualize />);
    ...
    it('debounces search input', async () => {
      ...
      renderWithProviders(<DataGridAdv onSearch={handleSearch} />);
  ...
  describe('Accessibility', () => {
    it('has proper ARIA attributes', () => {
      renderWithProviders(<DataGridAdv aria-label="Complex component" />);
      const container = document.querySelector('[data-testid="data-grid-adv"]');
