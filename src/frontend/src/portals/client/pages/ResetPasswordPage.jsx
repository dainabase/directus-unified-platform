...
const ResetPasswordPage = ({ token, onSuccess, companyLogo, companyName = 'Espace Client' }) => {
  const { resetPassword, isLoading, error } = useClientAuth();
  ...
  const validateToken = async () => {
    try {
      const response = await fetch(`/api/commercial/portal/validate-reset-token`, {
        method: 'POST',
      ...
      if (response.ok && data.valid) {
        ...
        setTokenValid(false);
        setLocalError(data.error || 'Lien de réinitialisation invalide ou expiré');
      }
    } catch (err) {
      setTokenValid(false);
              ...
              <div className="card shadow-lg border-0">
                <div className="card-body p-5 text-center">
                  ...
                  <p className="text-muted mb-4">
                    {localError || 'Ce lien de réinitialisation est invalide ou a expiré.'}
                  </p>
                  <button
            ...
            <div className="col-md-5 col-lg-4">
              <div className="card shadow-lg border-0">
                <div className="card-body p-5 text-center">
                  ...
                  <h4 className="fw-bold mb-3">Mot de passe réinitialisé</h4>
                  <p className="text-muted mb-4">
            ...
            <div className="card shadow-lg border-0">
              <div className="card-body p-5">
                ...
                <div className="text-center mb-4">
                  ...
                  <p className="text-muted small">Réinitialisez votre mot de passe</p>
                </div>
