 ...
 * Theme: violet/indigo (different from client emerald)
 */
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      autoFocus
                      className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-white/50 text-gray-900 placeholder:text-gray-400"
                    />
                  </div>
                </div>
