 ...
 * Auto-generated test suite for code-editor component
 * Category: complex
 */
...
describe('CodeEditor Component', () => {
  describe('Rendering', () => {
    it('renders without crashing', () => {
      ...
      expect(document.querySelector('[data-testid="code-editor"]')).toBeInTheDocument();
    });

    it('renders with initial data', () => {
      const data = { /* mock data */ };
      renderWithProviders(<CodeEditor data={data} />);
      // Verify data is rendered
    });

    it('handles loading state', () => {
      renderWithProviders(<CodeEditor loading />);
      expect(screen.getByRole('status')).toBeInTheDocument();
      expect(screen.getByText(/loading/i)).toBeInTheDocument();
    });

    it('handles error state', () => {
      renderWithProviders(<CodeEditor error="Failed to load" />);
  ...
  describe('Data Management', () => {
    it('loads data on mount', async () => {
      ...
      renderWithProviders(<CodeEditor onLoad={fetchData} />);
    ...
    it('handles data updates', async () => {
      const { rerender } = renderWithProviders(<CodeEditor data={[]} />);
      expect(screen.getByText(/no data/i)).toBeInTheDocument();
      
      const newData = [{ id: 1, name: 'Item 1' }];
      rerender(<CodeEditor data={newData} />);
    ...
    it('supports pagination', async () => {
      ...
      renderWithProviders(<CodeEditor data={data} pageSize={10} />);
    ...
    it('supports sorting', async () => {
      ...
      renderWithProviders(<CodeEditor data={data} sortable />);
    ...
    it('supports filtering', async () => {
      ...
      renderWithProviders(<CodeEditor data={data} filterable />);
  ...
  describe('User Interactions', () => {
    it('handles item selection', () => {
      ...
      renderWithProviders(<CodeEditor data={data} onSelect={handleSelect} />);
    ...
    it('supports multi-selection', () => {
      ...
      renderWithProviders(<CodeEditor data={data} multiSelect onSelect={handleSelect} />);
    ...
    it('supports drag and drop', async () => {
      ...
      renderWithProviders(<CodeEditor data={data} draggable onReorder={handleReorder} />);
    ...
    it('supports inline editing', async () => {
      ...
      const data = [{ id: 1, name: 'Item 1' }];
      renderWithProviders(<CodeEditor data={data} editable onEdit={handleEdit} />);
  ...
  describe('Performance', () => {
    it('virtualizes long lists', () => {
      ...
      renderWithProviders(<CodeEditor data={data} virtualize />);
    ...
    it('debounces search input', async () => {
      ...
      renderWithProviders(<CodeEditor onSearch={handleSearch} />);
  ...
  describe('Accessibility', () => {
    it('has proper ARIA attributes', () => {
      renderWithProviders(<CodeEditor aria-label="Complex component" />);
