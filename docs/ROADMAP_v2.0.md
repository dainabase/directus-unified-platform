...
| 0.5 | Intégration Revolut Business API | 🟢 | |
...
**Objectif** : Appliquer le Design System Apple Premium Monochromatic sur toute la plateforme avant toute nouvelle fonctionnalité.  
**Durée estimée** : 1 semaine

| # | Story | Prio | Statut | Notes |
|---|-------|------|--------|-------|
| 1.1 | Créer `src/styles/design-system.css` (tokens CSS complets) | 🔥 | 🔴 | Variables CSS conformes CDC v1.3 §14 |
| 1.2 | Créer composants UI de base : `Button`, `Badge`, `Card`, `Input` | 🔥 | 🔴 | Lib interne |
| 1.3 | Sidebar redesign complet | 🔥 | 🔴 | Glassmorphism, company switcher 5 entités |
| 1.4 | Topbar redesign | 🔥 | 🔴 | Search dynamique, actions, notifications dot |
| 1.5 | Dashboard SuperAdmin — appliquer Design System | 🔥 | 🔴 | |
| 1.6 | Créer composants réutilisables : `StatusDot`, `KPICard`, `DataTable`, `ProgressBar` | ⚡ | 🔴 | |
...
| 2.2 | Authentification multi-portails JWT | 🔥 | 🟡 | 4 rôles |
| 2.3 | Dashboard CEO — KPIs depuis vraies données | 🔥 | 🔴 | Collections : kpis, client_invoices, payments, projects |
| 2.4 | Dashboard CEO — Projets actifs en temps réel | 🔥 | 🔴 | |
| 2.5 | Dashboard CEO — Pipeline commercial | 🔥 | 🔴 | Collections : leads, quotes |
| 2.6 | Dashboard CEO — Trésorerie Revolut live | 🔥 | 🔴 | API Revolut → balance + transactions |
| 2.7 | Dashboard CEO — Alertes intelligentes | ⚡ | 🔴 | Factures retard, paiements en attente |
...
**Critère de sortie** : Le CEO peut voir ses vrais KPIs, projets et trésorerie sans données mockées.
...
| # | Story | Prio | Statut | Notes |
|---|-------|------|--------|-------|
| 3.1 | Finance — Factures clients (liste + détail + création) | 🔥 | 🔵 | Récupérer ancien 49KB |
| 3.2 | Finance — Factures fournisseurs (liste + OCR + validation) | 🔥 | 🔵 | Récupérer ancien 44KB |
| 3.3 | Finance — Comptabilité (plan PME Käfer) | ⚡ | 🔵 | Récupérer ancien 79KB |
| 3.4 | Finance — Banking Revolut (transactions + rapprochement) | 🔥 | 🟡 | BankingDashboard → compléter |
| 3.5 | **Module 17** — Rapports Mensuels P&L | ⚡ | 🔵 | Récupérer ancien 98KB |
| 3.6 | **Module 18** — Rapports TVA Suisse (Formulaire 200) | 🔥 | 🔵 | Récupérer ancien 70KB — obligation légale |
| 3.7 | **Module 19** — Dépenses (saisie + catégorisation + OCR) | ⚡ | 🔵 | Récupérer ancien 39KB |
| 3.8 | QR-Invoice génération (ISO 20022 v2.3) | 🔥 | 🟡 | Vérifier taux TVA 8.1/2.6/3.8 |
...
| ~~4.10~~ | ~~Performance~~ | ⚫ | ⚫ | Supprimé — décision Jean |
| ~~4.11~~ | ~~Récompenses~~ | ⚫ | ⚫ | Supprimé — décision Jean |
...
| 5.7 | Marketing revendeur | 📌 | 🔵 | Récupérer ancien 54KB |
...
| 8.2 | **Correction taux TVA OCR** (7.7→8.1, 2.5→2.6, 3.7→3.8) | 🔥 | 🔴 | TODO urgent : finance-ocr-ai.js, ocr-hybrid-processor.js, expenses-notion.js |
...
| 8.9 | MAJ ROADMAP.md après chaque story | 🔥 | 🔴 | Règle Claude Code — obligatoire |

---

## PHASE 9 — MULTI-ENTREPRISES 📌

**Déclencheur** : HYPERVISUAL Switzerland V1 validée et stable
...
| 9.4 | ENKI REALTY — onboarding | 📌 | 🔴 | orthographe exacte |
...
2. **Vérification Directus** : MCP pour confirmer les champs avant de coder
3. **MAJ ROADMAP.md** : marquer la story comme complétée après chaque livraison
4. **Design System** : référencer `src/styles/design-system.css`
5. **Commit clair** : `feat(phase-X): story X.X — description`

---

*Roadmap v2.0 — Février 2026*  
*Remplace la roadmap incluse dans CDC v1.2 §11*  
*97 stories identifiées — ~20% global complété*
