/**
 * ImageCropper Component Tests
 * Auto-generated test suite for image-cropper component
 * Category: complex
 */
...
describe('ImageCropper Component', () => {
  describe('Rendering', () => {
    it('renders without crashing', () => {
      ...
      expect(document.querySelector('[data-testid="image-cropper"]')).toBeInTheDocument();
    });

    it('renders with initial data', () => {
      const data = { /* mock data */ };
      renderWithProviders(<ImageCropper data={data} />);
      // Verify data is rendered
    });

    it('handles loading state', () => {
      renderWithProviders(<ImageCropper loading />);
      expect(screen.getByRole('status')).toBeInTheDocument();
      expect(screen.getByText(/loading/i)).toBeInTheDocument();
    });

    it('handles error state', () => {
      renderWithProviders(<ImageCropper error="Failed to load" />);
  ...
  describe('Data Management', () => {
    it('loads data on mount', async () => {
      ...
      renderWithProviders(<ImageCropper onLoad={fetchData} />);
    ...
    it('handles data updates', async () => {
      const { rerender } = renderWithProviders(<ImageCropper data={[]} />);
      expect(screen.getByText(/no data/i)).toBeInTheDocument();
      
      const newData = [{ id: 1, name: 'Item 1' }];
      rerender(<ImageCropper data={newData} />);
    ...
    it('supports pagination', async () => {
      ...
      renderWithProviders(<ImageCropper data={data} pageSize={10} />);
    ...
    it('supports sorting', async () => {
      ...
      renderWithProviders(<ImageCropper data={data} sortable />);
    ...
    it('supports filtering', async () => {
      ...
      renderWithProviders(<ImageCropper data={data} filterable />);
  ...
  describe('User Interactions', () => {
    it('handles item selection', () => {
      ...
      renderWithProviders(<ImageCropper data={data} onSelect={handleSelect} />);
    ...
    it('supports multi-selection', () => {
      ...
      renderWithProviders(<ImageCropper data={data} multiSelect onSelect={handleSelect} />);
    ...
    it('supports drag and drop', async () => {
      ...
      renderWithProviders(<ImageCropper data={data} draggable onReorder={handleReorder} />);
    ...
    it('supports inline editing', async () => {
      ...
      const data = [{ id: 1, name: 'Item 1' }];
      renderWithProviders(<ImageCropper data={data} editable onEdit={handleEdit} />);
  ...
  describe('Performance', () => {
    it('virtualizes long lists', () => {
      ...
      renderWithProviders(<ImageCropper data={data} virtualize />);
    ...
    it('debounces search input', async () => {
      ...
      renderWithProviders(<ImageCropper onSearch={handleSearch} />);
  ...
  describe('Accessibility', () => {
    it('has proper ARIA attributes', () => {
      renderWithProviders(<ImageCropper aria-label="Complex component" />);
      const container = document.querySelector('[data-testid="image-cropper"]');
