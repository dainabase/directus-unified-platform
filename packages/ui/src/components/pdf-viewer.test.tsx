 ...
 * Auto-generated test suite for pdf-viewer component
 * Category: complex
 */
...
describe('PdfViewer Component', () => {
  describe('Rendering', () => {
    it('renders without crashing', () => {
      renderWithProviders(<PdfViewer />);
      expect(document.querySelector('[data-testid="pdf-viewer"]')).toBeInTheDocument();
    });

    it('renders with initial data', () => {
      const data = { /* mock data */ };
      renderWithProviders(<PdfViewer data={data} />);
      // Verify data is rendered
    });

    it('handles loading state', () => {
      renderWithProviders(<PdfViewer loading />);
      expect(screen.getByRole('status')).toBeInTheDocument();
      expect(screen.getByText(/loading/i)).toBeInTheDocument();
    });

    it('handles error state', () => {
      renderWithProviders(<PdfViewer error="Failed to load" />);
  ...
  describe('Data Management', () => {
    it('loads data on mount', async () => {
      ...
      renderWithProviders(<PdfViewer onLoad={fetchData} />);
    ...
    it('handles data updates', async () => {
      const { rerender } = renderWithProviders(<PdfViewer data={[]} />);
      expect(screen.getByText(/no data/i)).toBeInTheDocument();
      
      const newData = [{ id: 1, name: 'Item 1' }];
      rerender(<PdfViewer data={newData} />);
    ...
    it('supports pagination', async () => {
      ...
      renderWithProviders(<PdfViewer data={data} pageSize={10} />);
    ...
    it('supports sorting', async () => {
      ...
      renderWithProviders(<PdfViewer data={data} sortable />);
    ...
    it('supports filtering', async () => {
      ...
      renderWithProviders(<PdfViewer data={data} filterable />);
  ...
  describe('User Interactions', () => {
    it('handles item selection', () => {
      ...
      renderWithProviders(<PdfViewer data={data} onSelect={handleSelect} />);
    ...
    it('supports multi-selection', () => {
      ...
      renderWithProviders(<PdfViewer data={data} multiSelect onSelect={handleSelect} />);
    ...
    it('supports drag and drop', async () => {
      ...
      renderWithProviders(<PdfViewer data={data} draggable onReorder={handleReorder} />);
    ...
    it('supports inline editing', async () => {
      ...
      const data = [{ id: 1, name: 'Item 1' }];
      renderWithProviders(<PdfViewer data={data} editable onEdit={handleEdit} />);
  ...
  describe('Performance', () => {
    it('virtualizes long lists', () => {
      ...
      renderWithProviders(<PdfViewer data={data} virtualize />);
    ...
    it('debounces search input', async () => {
      ...
      renderWithProviders(<PdfViewer onSearch={handleSearch} />);
  ...
  describe('Accessibility', () => {
    it('has proper ARIA attributes', () => {
      renderWithProviders(<PdfViewer aria-label="Complex component" />);
      const container = document.querySelector('[data-testid="pdf-viewer"]');
  ...
  describe('PDF Specific Features', () => {
    it('handles page navigation', async () => {
      renderWithProviders(<PdfViewer src="/test.pdf" totalPages={10} />);
    ...
    it('supports zoom functionality', () => {
      renderWithProviders(<PdfViewer src="/test.pdf" />);
    ...
    it('handles download functionality', () => {
      ...
      renderWithProviders(<PdfViewer src="/test.pdf" onDownload={handleDownload} />);
    ...
    it('supports print functionality', () => {
      ...
      renderWithProviders(<PdfViewer src="/test.pdf" onPrint={handlePrint} />);
