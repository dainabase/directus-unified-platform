 ...
 * Auto-generated test suite for tooltip component
 * Category: feedback
 */
...
describe('Tooltip Component', () => {
  describe('Rendering', () => {
    ...
    it('renders with message content', () => {
      renderWithProviders(<Tooltip message="Test message" />);
  ...
  describe('Variants', () => {
    ...
    variants.forEach(variant => {
      it(`renders ${variant} variant`, () => {
        renderWithProviders(<Tooltip variant={variant} />);
  ...
  describe('Visibility Control', () => {
    it('shows and hides correctly', async () => {
      const { rerender } = renderWithProviders(<Tooltip open={true} />);
    ...
    it('auto-dismisses after timeout', async () => {
      renderWithProviders(<Tooltip autoClose duration={1000} />);
      await waitFor(() => {
    ...
    it('handles close button click', () => {
      ...
      renderWithProviders(<Tooltip onClose={handleClose} />);
  ...
  describe('Accessibility', () => {
    ...
    it('manages focus for modals', () => {
      renderWithProviders(<Tooltip modal />);
